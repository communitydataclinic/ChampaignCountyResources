...
<div class="inner_services login_register">
	...
	<div class="col-md-6 col-md-offset-3">
		{{ Form::open(array('route' => 'register', 'class' => 'form-horizontal form-signin register_form','files' => true)) }}
			...
			<p>Please register to manage the information of your organization. We will contact you to verify your information and activate your user..</p>
			<p></p>
			<div class="col-md-6">
			...
			<div class="col-md-12">
				<div class="form-group  {{ $errors->has('email') ? 'has-error' : ''}}">
					<label for="email">Your E-mail (organization's account preferred) *</label>
